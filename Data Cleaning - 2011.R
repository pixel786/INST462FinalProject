...
br <- subset(br, select = c("X_STATE", "IYEAR", "CADULT", "GENHLTH", "HLTHPLN1", 
...
#write.csv(br, "/Users/zainabsherani/Desktop/INST462 - Final Project/2011cleaned.csv")
